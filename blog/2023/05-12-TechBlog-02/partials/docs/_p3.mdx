...
Hiện tại, mình đã thực hiện Khóa luận tốt nghiệp về **Điện toán đám mây** và mô hình **Infrastructure as Code (IaC)**.
...
<!-- prettier-ignore -->
<a href="https://www.builetuananh.name.vn/services" style={{ backgroundColor: "#25c2a0", borderRadius: "2px", color: "#fff", padding: "0.3rem", }} target="_blank">Truy cập</a>
